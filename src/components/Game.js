		...
		<>
			...
			<div className='gameKeyboard'>
				<div className='gameKeyboardRow1'>
					...
					<button className='keyboardButton' onClick={() => handleType('Q')}>Q</button>
					<button className='keyboardButton' onClick={() => handleType('W')}>W</button>
					<button className='keyboardButton' onClick={() => handleType('E')}>E</button>
					<button className='keyboardButton' onClick={() => handleType('R')}>R</button>
					<button className='keyboardButton' onClick={() => handleType('T')}>T</button>
					<button className='keyboardButton' onClick={() => handleType('Y')}>Y</button>
					<button className='keyboardButton' onClick={() => handleType('U')}>U</button>
					<button className='keyboardButton' onClick={() => handleType('I')}>I</button>
					<button className='keyboardButton' onClick={() => handleType('O')}>O</button>
					<button className='keyboardButton' onClick={() => handleType('P')}>P</button>
				</div>
				<div className='gameKeyboardRow2'>
					<button className='keyboardButton' onClick={() => handleType('A')}>A</button>
					<button className='keyboardButton' onClick={() => handleType('S')}>S</button>
					<button className='keyboardButton' onClick={() => handleType('D')}>D</button>
					<button className='keyboardButton' onClick={() => handleType('F')}>F</button>
					<button className='keyboardButton' onClick={() => handleType('G')}>G</button>
					<button className='keyboardButton' onClick={() => handleType('H')}>H</button>
					<button className='keyboardButton' onClick={() => handleType('J')}>J</button>
					<button className='keyboardButton' onClick={() => handleType('K')}>K</button>
					<button className='keyboardButton' onClick={() => handleType('L')}>L</button>
				</div>
				<div className='gameKeyboardRow3'>
					<button className='keyboardButtonCheck' onClick={() => handleCheckWord()}>Enter</button>
					<button className='keyboardButton' onClick={() => handleType('Z')}>Z</button>
					<button className='keyboardButton' onClick={() => handleType('X')}>X</button>
					<button className='keyboardButton' onClick={() => handleType('C')}>C</button>
					<button className='keyboardButton' onClick={() => handleType('V')}>V</button>
					<button className='keyboardButton' onClick={() => handleType('B')}>B</button>
					<button className='keyboardButton' onClick={() => handleType('N')}>N</button>
					<button className='keyboardButton' onClick={() => handleType('M')}>M</button>
